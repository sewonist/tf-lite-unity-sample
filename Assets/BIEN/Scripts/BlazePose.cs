...
/// </summary>
public sealed class BlazePose : MonoBehaviour
{
    public enum Mode
    {
        UpperBody,
    ...
    [SerializeField] RawImage rawView = null;
    ...
    void Start()
    {
        ...
        TextureResizer.ResizeOptions poseOptions = new TextureResizer.ResizeOptions()
        {
        ...
        TextureResizer.ResizeOptions landOptions = new TextureResizer.ResizeOptions()
        {
            aspectMode = TextureResizer.AspectMode.Fill,
            rotationDegree = 0,
            mirrorHorizontal = false,
        ...
        //poseDetect.ResizeOptions = poseOptions;
        //poseLandmark.ResizeOptions = landOptions;
